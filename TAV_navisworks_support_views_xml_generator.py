...
print (pri_supports)
print (len(pri_supports))
print (sec_supports)
print (len(sec_supports))
print (pri_systems)
print (sec_systems)
...
for key in all_pri_and_sec_supports:
    ...
    final_xml_string = final_xml_string + create_views_for_one_list(all_pri_and_sec_supports[key][0], all_pri_and_sec_supports[key][1])
    final_xml_string = final_xml_string + '\n </viewfolder> \n'
